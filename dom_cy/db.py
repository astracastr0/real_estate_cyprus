"""SQLite database helpers for dom.com.cy listings."""
...
def query_df(sql: str, params=()):
    """Execute SQL and return results as list of dicts (for pandas)."""
    conn = get_connection()
